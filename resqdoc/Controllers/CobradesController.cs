...
namespace resqdoc.Controllers
{
    public class CobradesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Cod,Descricao,Id")] Cobrade cobrade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Cod,Descricao,Id")] Cobrade cobrade)
        {
            if (id != cobrade.Id)
            {
                return NotFound();
        ...
        private bool CobradeExists(long id)
        {
